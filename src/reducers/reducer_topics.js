export default function() {
  return [
    ...
    {
        title: "Interests",
        subTitle1Context: ["I'm a regular attendee on the meetup circuit (TwitterDev, Silicon Drinkabout and have even been known to attend a Saturday morning Katathon).", "When I'm not debugging, refactoring or otherwise getting to grips with the latest technologies, I love to get outdoors. I'm a keen swimmer and a slightly less than enthusiastic runner, though I did struggle through the London Marathon this year - I'm nothing if not persevering."]
    }
  ]
}
